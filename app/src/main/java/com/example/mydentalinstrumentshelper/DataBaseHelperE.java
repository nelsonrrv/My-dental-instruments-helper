...
public class DataBaseHelperE extends SQLiteOpenHelper {
    ...
    public DataBaseHelperE(@Nullable Context context) {

        super(context, "instrumentse.db", null, 1);
    ...
    public boolean addOneE (Instruments instruments) {
    ...
    public boolean modificarOneE (Instruments instruments) {
    ...
    public List<Instruments> getEveryoneE (){
    ...
    public boolean deleteOneE (Instruments instruments){
    ...
    public String[] buscarOneE (String buscar){
