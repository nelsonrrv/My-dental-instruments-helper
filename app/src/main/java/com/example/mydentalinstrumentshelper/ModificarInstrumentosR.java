...
public class ModificarInstrumentosR extends Activity {
        ...
        btn.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    Toast.makeText(ModificarInstrumentosR.this, "Error modificando instrumento", Toast.LENGTH_SHORT).show();
                    instruments = new Instruments( -1, "error", "error", 0);
                }

                DataBaseHelperR dataBaseHelperR = new DataBaseHelperR(ModificarInstrumentosR.this);

                boolean success = dataBaseHelperR.modificarOneR(instruments);

                Toast.makeText( ModificarInstrumentosR.this, "Instrumento modificado="+success, Toast.LENGTH_SHORT).show();
