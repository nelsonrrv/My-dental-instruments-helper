...
public class DataBaseHelperD extends SQLiteOpenHelper {
    ...
    public DataBaseHelperD(@Nullable Context context) {
        ...
        super(context, "instrumentsd.db", null, 1);
    ...
    public boolean addOneD (Instruments instruments) {
    ...
    public boolean modificarOneD (Instruments instruments) {
    ...
    public List<Instruments> getEveryoneD (){
    ...
    public boolean deleteOneD (Instruments instruments){
    ...
    public String[] buscarOneD (String buscar){
