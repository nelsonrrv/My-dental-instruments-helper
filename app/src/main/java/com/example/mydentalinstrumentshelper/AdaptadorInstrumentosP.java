...
public class AdaptadorInstrumentosP extends BaseAdapter {

    Activity mActivity;
    DataBaseHelperP dataBaseHelperP;

    public AdaptadorInstrumentosP(Activity mActivity, DataBaseHelperP dataBaseHelperP) {
        this.mActivity = mActivity;
        this.dataBaseHelperP = dataBaseHelperP;
    }

    @Override
    public int getCount() {
        return dataBaseHelperP.getEveryoneP().size();
    }

    @Override
    public Instruments getItem(int position) {

        return dataBaseHelperP.getEveryoneP().get(position);
    }
