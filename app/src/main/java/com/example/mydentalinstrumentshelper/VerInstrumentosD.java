...
class VerInstrumentosD extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.vista_lista_instrumentosd);

        lv_todos = (ListView) findViewById(R.id.lv_todosd);

        dataBaseHelperD = new DataBaseHelperD(VerInstrumentosD.this);

        adapter = new AdaptadorInstrumentosD ( VerInstrumentosD.this, dataBaseHelperD);
        ...
        lv_todos.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(VerInstrumentosD.this);
