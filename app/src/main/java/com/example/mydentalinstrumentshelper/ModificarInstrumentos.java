...
public class ModificarInstrumentos extends Activity {
        ...
        btn.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    Toast.makeText(ModificarInstrumentos.this, "Error modificando instrumento", Toast.LENGTH_SHORT).show();
                    instruments = new Instruments( -1, "error", "error", 0);
                }

                DataBaseHelperC dataBaseHelperC = new DataBaseHelperC(getApplicationContext());

                long mod  = dataBaseHelperC.modificarOne(instruments);
                Toast.makeText(ModificarInstrumentos.this, "Instrumento modificado=" + mod, Toast.LENGTH_SHORT).show();
