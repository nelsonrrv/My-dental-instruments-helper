...
public class DataBaseHelperR extends SQLiteOpenHelper {
    ...
    public DataBaseHelperR(@Nullable Context context) {
        ...
        super(context, "instrumentsr.db", null, 1);
    ...
    public boolean addOneR (Instruments instruments) {
    ...
    public boolean modificarOneR (Instruments instruments) {
    ...
    public List<Instruments> getEveryoneR (){
    ...
    public boolean deleteOneR (Instruments instruments){
    ...
    public String[] buscarOneR (String buscar){
