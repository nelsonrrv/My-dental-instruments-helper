...
public class DataBaseHelperC extends SQLiteOpenHelper {
    ...
    public DataBaseHelperC(@Nullable Context context) {

        super(context, "instrumentsc.db", null, 1);
    ...
    public boolean addOne (Instruments instruments) {
    ...
    public boolean modificarOne (Instruments instruments) {
        ...
        cv.put(COLUMN_NOMBRE_INSTRUMENTO, instruments.getNombre());
        cv.put(COLUMN_MARCA_INSTRUMENTO, instruments.getMarca());
        String[] argumentosParaActualizar = {String.valueOf(instruments.getId())};

      long mod= db.update(INSTRUMENTS_TABLE, cv,  COLUMN_ID + " = ?",argumentosParaActualizar);
    ...
    public List<Instruments> getEveryone (){
    ...
    public boolean deleteOne (Instruments instruments){
