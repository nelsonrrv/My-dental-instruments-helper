...
public class AddInstrumentsE extends Activity implements OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btnAdd.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Toast.makeText(AddInstrumentsE.this, "Error agregando instrumental", Toast.LENGTH_SHORT).show();
                    instruments = new Instruments(-1, "error", "error", 0);
                }

                DataBaseHelperE dataBaseHelperE = new DataBaseHelperE(AddInstrumentsE.this);

                boolean success = dataBaseHelperE.addOneE(instruments);

                Toast.makeText(AddInstrumentsE.this, "Instrumento agregado=" + success, Toast.LENGTH_SHORT).show();
        ...
        btnList.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dataBaseHelperE = new DataBaseHelperE(AddInstrumentsE.this);

                adapter = new AdaptadorInstrumentosE(AddInstrumentsE.this, dataBaseHelperE);
        ...
        lv_instrumentos.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(AddInstrumentsE.this);
    ...
    private void MostrarListaInstrumentos(DataBaseHelperE dataBaseHelper2) {
        instrumentsArrayAdapter = new ArrayAdapter<Instruments>(AddInstrumentsE.this, android.R.layout.simple_list_item_1, dataBaseHelper2.getEveryoneE());
