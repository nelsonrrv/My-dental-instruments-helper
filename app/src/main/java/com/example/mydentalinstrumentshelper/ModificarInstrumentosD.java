...
public class ModificarInstrumentosD extends Activity {
        ...
        btn.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    Toast.makeText(ModificarInstrumentosD.this, "Error modificando instrumento", Toast.LENGTH_SHORT).show();
                    instruments = new Instruments( -1, "error", "error", 0);
                }

                DataBaseHelperD dataBaseHelperD = new DataBaseHelperD(ModificarInstrumentosD.this);

                boolean success = dataBaseHelperD.modificarOneD(instruments);

                Toast.makeText( ModificarInstrumentosD.this, "Instrumento modificado="+success, Toast.LENGTH_SHORT).show();
