...
public class AdaptadorInstrumentosD extends BaseAdapter {

    Activity mActivity;
    DataBaseHelperD dataBaseHelperD;

    public AdaptadorInstrumentosD(Activity mActivity, DataBaseHelperD dataBaseHelperD) {
        this.mActivity = mActivity;
        this.dataBaseHelperD = dataBaseHelperD;
    }

    @Override
    public int getCount() {
        return dataBaseHelperD.getEveryoneD().size();
    }

    @Override
    public Instruments getItem(int position) {

        return dataBaseHelperD.getEveryoneD().get(position);
    }
