...
public class AddInstrumentsP extends Activity implements OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btnAdd.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Toast.makeText(AddInstrumentsP.this, "Error agregando instrumental", Toast.LENGTH_SHORT).show();
                    instruments = new Instruments(-1, "error", "error", 0);
                }

                DataBaseHelperP dataBaseHelperP = new DataBaseHelperP(AddInstrumentsP.this);

                boolean success = dataBaseHelperP.addOneP(instruments);

                Toast.makeText(AddInstrumentsP.this, "Instrumento agregado=" + success, Toast.LENGTH_SHORT).show();
        ...
        btnList.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dataBaseHelperP = new DataBaseHelperP(AddInstrumentsP.this);

                adapter = new AdaptadorInstrumentosP(AddInstrumentsP.this, dataBaseHelperP);
        ...
        lv_instrumentos.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(AddInstrumentsP.this);
    ...
    private void MostrarListaInstrumentos(DataBaseHelperP dataBaseHelper2) {
        instrumentsArrayAdapter = new ArrayAdapter<Instruments>(AddInstrumentsP.this, android.R.layout.simple_list_item_1, dataBaseHelper2.getEveryoneP());
